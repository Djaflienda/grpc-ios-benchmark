...
type ProductServiceClient interface {
	GetProducts(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductList, error)
}
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductList, error) {
...
type ProductServiceServer interface {
	GetProducts(context.Context, *ProductRequest) (*ProductList, error)
...
func (UnimplementedProductServiceServer) GetProducts(context.Context, *ProductRequest) (*ProductList, error) {
